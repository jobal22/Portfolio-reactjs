    ...
    <div className='aboutUs'>
      <section className='bookEvent'>
        ...
        <div className='bookEvent__content'>
          ...
          <button><Link className='aboutUsLink'>Book Event</Link></button>
        </div>
      </section>
      ...
      <section className='teamMember'>
        <img className='teamMember__background'/>
        <div className='teamMember__content'>
          <h1>Coffee with Personality</h1>
          <button><Link className='aboutUsLink'>Meet Our Team</Link></button>
        </div>
      </section>
      ...
      <footer className="AU__footer">
        <ol className='footIcon'>
          <li><a className='fIcon far fa-envelope'></a></li>
          <li><a className='fIcon fab fa-linkedin-in'></a></li>
          <li><a className='fIcon fab fa-instagram' ></a></li>
        </ol>
